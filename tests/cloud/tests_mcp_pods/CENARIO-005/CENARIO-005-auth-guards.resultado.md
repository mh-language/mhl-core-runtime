...
| Item | Valor |
|---|---|
| Binário | `tests/cloud/tests/CENARIO-005/mhl` (cópia de `tests/cloud/mhl`, reconstruído do source atual) |
| Versão | `mhl v1.1.0-alpha-7-g418d7dc-dirty` |
| Servidor principal | `mhl serve mcp --http --addr 127.0.0.1:8722 --token <gerado> --state-dir <tmp> tests/cloud` |
| 2º servidor (controle) | `mhl serve mcp --http --addr 0.0.0.0:8723 --state-dir <tmp> tests/cloud` (**sem** `--token`) |
