...
**Execução:** 20260901-093647 · binário `mhl v1.1.0-alpha-8-g274d040-dirty` · TIMEOUT 300s · RUN_K8S=0
...
| 002 | stateless | PASS | 0s | [logs-regression/CENARIO-002-stateless.log](logs-regression/CENARIO-002-stateless.log) |
