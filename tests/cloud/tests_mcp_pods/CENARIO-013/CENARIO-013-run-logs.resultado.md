...
| Item | Valor |
|---|---|
| Binário | `tests/cloud/tests/CENARIO-013/mhl` (cópia de `tests/cloud/mhl`) |
| Versão | `mhl v1.1.0-alpha-7-g418d7dc-dirty` |
| Servidor | `mhl serve mcp --http --addr 127.0.0.1:8734 --token <gerado> --state-dir <tmp> tests/cloud` |
