...
```sh
cd src/mhl-extensoes/mhl-blob-s3
...
make release    # dist/mhl-blob-s3/ + bin/mhl-blob-s3-<goos>-<goarch> x5, then dist/release/mhl-blob-s3.tar.gz + SHA256SUMS
```
...
mhl extension install /path/to/src/mhl-extensoes/mhl-blob-s3
