...
```sh
cd src/mhl-extensoes/mhl-store-sqlite
...
make release    # dist/mhl-store-sqlite/ + bin/mhl-store-sqlite-<goos>-<goarch> x5, then dist/release/mhl-store-sqlite.tar.gz
```

## Use from a project

```sh
mhl extension install /path/to/src/mhl-extensoes/mhl-store-sqlite
