...
**Execução:** 20260902-072944 · binário `mhl v1.2.2-beta.1-dirty` · TIMEOUT 240s · RUN_K8S=0
...
| 006 | principal-isolation | PASS | 3s | [logs-regression/CENARIO-006-principal-isolation.log](logs-regression/CENARIO-006-principal-isolation.log) |
...
| 015 | inputschema-validation | PASS | 0s | [logs-regression/CENARIO-015-inputschema-validation.log](logs-regression/CENARIO-015-inputschema-validation.log) |
