...
| Item | Valor |
|---|---|
| Binário | `sample/cloud/tests/CENARIO-012/mhl` (cópia de `sample/cloud/mhl`) |
| Versão | `mhl v1.1.0-alpha-7-g418d7dc-dirty` |
| Servidor | `mhl serve mcp --http --addr 127.0.0.1:8733 --token <gerado> --state-dir <tmp> sample/cloud` |
