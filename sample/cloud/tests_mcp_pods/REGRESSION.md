...
**Execução:** 20260831-151655 · binário `mhl v1.1.0-alpha-7-g418d7dc-dirty` · TIMEOUT 300s · RUN_K8S=0
...
| 009 | drain-shutdown | PASS | 8s | [logs-regression/CENARIO-009-drain-shutdown.log](logs-regression/CENARIO-009-drain-shutdown.log) |
| 010 | step-timeout | PASS | 10s | [logs-regression/CENARIO-010-step-timeout.log](logs-regression/CENARIO-010-step-timeout.log) |
...
| 013 | run-logs | PASS | 1s | [logs-regression/CENARIO-013-run-logs.log](logs-regression/CENARIO-013-run-logs.log) |
| 014 | protocol-conformance | PASS | 0s | [logs-regression/CENARIO-014-protocol-conformance.log](logs-regression/CENARIO-014-protocol-conformance.log) |
